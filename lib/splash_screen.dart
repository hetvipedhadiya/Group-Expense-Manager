      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: isLight
                ? [
              const Color(0xFF334155), // lighter than 1E293B
              const Color(0xFF475569), // soft slate
              const Color(0xFF64748B), // smooth fade
            ]
                : [
              const Color(0xFF0F172A), // slightly lighter dark
